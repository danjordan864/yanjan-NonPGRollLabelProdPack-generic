...
namespace RollLabelProdPack
{
    ...
    /// </summary>
    public partial class RocklineSelectOrderDialog : Form
    {
        /// <summary>
        ...
        /// </summary>
        public RocklineSelectOrderDialog()
        {
            InitializeComponent();
        }
        ...
        internal void SetDataSource(string itemGroupFilter)
        {
            try
            {
                ...
                var so = AppData.GetOpenProdOrders(itemGroupFilter, AppUtility.GetRocklineCustomerID());
