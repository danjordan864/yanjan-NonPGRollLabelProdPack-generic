...
namespace RollLabelProdPack
{
    ...
    /// </summary>
    public partial class FrmReprintOrderRollsDialogRockline : Form
    {
        /// <summary>
        ...
        /// </summary>
        public FrmReprintOrderRollsDialogRockline()
        {
            InitializeComponent();
        }
        ...
        private void FrmReprintOrderRollsDialog_Load(object sender, EventArgs e)
        {
            ...
            var so = AppData.GetRollsForOrder(YJNOrderNo, AppUtility.GetRocklineCustomerID());
            if (!so.SuccessFlag)
